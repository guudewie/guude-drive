export function setToast(message) {
  ...
  toastElement.className =
    "flex invisible fixed right-5 bottom-5 items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm";
  ...
  toastElement.style.bottom = `${yOffset + 20}px`; // 20px base offset
